...
class Credit_checkTest < Minitest::Test
  ...
  def test_it_separates_each_digit
    assert_equal [5, 5, 4, 1, 8, 0, 8, 9, 2, 3, 7, 9, 5, 2, 4, 0], @credit_check.each_digit("5541808923795240")
  end
  ...
  def test_it_fixes_digits_greater_than_9
    assert_equal [1, 5, 8, 1, 7, 0, 7, 9, 4, 3, 5, 9, 1, 2, 8, 0], @credit_check.digits_greater_than_9("5541808923795240")
  end

  def test_it_returns_the_digits_sum
    assert_equal 70, @credit_check.digits_sum("5541808923795240")
  end

  def test_is_it_divisible_by_10
    assert true, @credit_check.divisible_by_10?("5541808923795240")
  end

  def test_it_returns_valid_card
    assert_equal true, @credit_check.valid_card?("5541808923795240")
  end

  def test_it_returns_card_validation_output
    assert_equal "The number is valid!", @credit_check.validation_output("5541808923795240")
  end
end
